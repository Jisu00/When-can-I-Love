...
var quest = {
  ...
  7: {
    "title": "평소 관심 있던 사람이<br><span class='half_HL'>술을 마시자고 한다</span>.",
    "A": {
      "text": "기회다🤩\n같이 마셔요!",
      "type": "",
      "score": 1
  ...
  9: {
    "title": "<span class='half_HL'>이상형</span>을<br>발견했을 때<br> 나는",
    "A": {
      "text": "모 아니면 도!\n적극적으로 들이댄다.",
      "type": "",
      "score": 1
  ...
  11: {
    "title": "이상형을 말하면<span class='half_HL'>친구들은 나에게</span><br>",
    "A": {
...
function clickFunction(e) {
  ...
  A.disabled = "true";
  B.disabled = "true";
  var typeResult = quest[page_num][idValue]["type"];
...
function init() {
  ...
  setInterval(function () {
    if (flag == 1) heart_img.style.transform = "scale(1)";else heart_img.style.transform = "scale(0.9)";
    flag *= -1;
  }, 1000);
  nextQuestion();
}
...
var paper = document.querySelector(".num_paper");
var click_me = document.querySelector("#click_me");
var retest = document.querySelector("#retest");
...
var qm1 = document.querySelector(".qm1");
var qm2 = document.querySelector(".qm2");
var btn_start = document.querySelector("#btn_start");
var start_page = document.querySelector(".start_page");
...
var getFromServer = function getFromServer() {
  var serverData = document.querySelector(".result_server").innerHTML.split("/");
...
var calResultTitle = function calResultTitle() {
...
var calResultAbility = function calResultAbility() {
  var CA = finalResult["CA"];
  var PO = finalResult["PO"];
  var AC = finalResult["AC"];
  var AW = finalResult["AW"];
  if (CA == 3 && PO == 3 && AC == 3 && AW == 3) abilityTip.innerText = resultAbility["1"];else if (CA == 0 && PO == -3 && AC == 0 && AW == 0) abilityTip.innerText = resultAbility["2"];else {
...
/* harmony import */ var _result__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./result */ "./src/assets/js/result.js");
/* harmony import */ var _result__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_result__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _question__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./question */ "./src/assets/js/question.js");
/* harmony import */ var _question__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_question__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _css_font_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../css/font.css */ "./src/assets/css/font.css");
/* harmony import */ var _css_style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../css/style.css */ "./src/assets/css/style.css");
/* harmony import */ var _css_animation_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../css/animation.css */ "./src/assets/css/animation.css");
/* harmony import */ var _css_progressbar_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../css/progressbar.css */ "./src/assets/css/progressbar.css");
